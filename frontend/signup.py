...
class Ui_SignupWindow(object):
    def setupUi(self, SignupWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(160, 60, 401, 441))
...
"}")
        ...
        self.lineEdit_S_email_address.setMinimumSize(QtCore.QSize(0, 30))
...
"}")
        ...
        self.pushButton_S_send.setGeometry(QtCore.QRect(300, 80, 75, 30))
...
"}")
    ...
    def retranslateUi(self, SignupWindow):
        ...
        self.label_2.setText(_translate("SignupWindow", "邮箱输入错误！"))
