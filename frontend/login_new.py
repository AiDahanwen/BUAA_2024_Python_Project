...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.lineEdit_L_password.setStyleSheet(
            "QLineEdit{\n"
            "    border:none;\n"
            "    border-bottom:1.5px solid black\n"
            "}"
        ...
        self.pushButton_L_login.setStyleSheet(
            "QPushButton{\n"
        ...
        self.pushButton_L_signup.setStyleSheet(
            "QPushButton:hover{\n"
            "    padding-left:5px;\n"
            "    padding-top:5px;\n"
            "}"
        ...
        self.pushButton_L_forget.setStyleSheet(
            "QPushButton:hover{\n"
            "    padding-top:5px;\n"
            "    padding-left:5px;\n"
            "}"
        ...
        sizePolicy.setHeightForWidth(
            self.stackedWidget_2.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.label_L_daily_sentence.setText(
            _translate(
                "LoginWindow",
                "此处放每日一句aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
            )
        )
        self.lineEdit_L_account.setPlaceholderText(_translate("LoginWindow", "邮箱："))
        self.lineEdit_L_password.setPlaceholderText(
            _translate("LoginWindow", " 密码：")
        )
        self.pushButton_L_login.setText(_translate("LoginWindow", "登  录"))
        self.pushButton_L_signup.setText(
            _translate("LoginWindow", "注册                             ")
        )
        self.pushButton_L_forget.setText(
            _translate("LoginWindow", "                  忘记密码？")
        )
