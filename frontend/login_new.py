...
"}")
        ...
        self.frame_2.setGeometry(QtCore.QRect(10, 140, 491, 431))
...
"border-radius:10px;")
        ...
        self.verticalLayout_3.addWidget(self.pushButton_L_login)
...
"}")
        ...
        self.verticalLayout_3.addWidget(self.pushButton_L_forget)
