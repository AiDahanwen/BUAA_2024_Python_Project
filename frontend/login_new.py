...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        font.setBold(True)
        font.setWeight(75)
        self.label_L_daily_sentence.setFont(font)
        self.label_L_daily_sentence.setStyleSheet("")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/24gl-minimization.png"), QtGui.QIcon.Normal,
                       QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/Close.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.label_L_daily_sentence.setText(_translate("LoginWindow", "白日依山尽，黄河入海流。\n"
                                                                      "欲穷千里目，更上一层楼。"))
